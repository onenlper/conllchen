...
public class TuneEnglish {
	public static void main(String args[]) throws Exception {
		String language = "english";
		String folder = args[1];
		String optFn = language + "_" + folder + "_opt2_only_constraint2";
		fw = new FileWriter(language + "_" + folder + "_tuning_final");
		ArrayList<Double> t5s = new ArrayList<Double>();
//		for (double a = -0.05; a <=0.3;) {
//			t5s.add(a);
//			a += 0.05;
//		}
//		double t1s[] = { -0.1, 0, 0.05, 0.15, 0.25, 0.35 };
//		double t2s[] = { -0.1, 0, 0.05, 0.15, 0.25, 0.35};
...
//		double t4s[] = { 1.1, 1.0, 0.95, 0.85, 0.75, 0.65, 0.55 };
		...
		a2[0] = "/users/yzcchen/chen3/conll12/english/" + folder + "_development2/";
		a2[1] = "system";
		int iteration = 0;
		while(true) {
			iteration++;
...
//		outs.add(sb.toString());
	...
	public static void runSieve(String args[], ArrayList<Boolean> bs2) throws Exception {
		...
		fw.write(sb.toString() + "\n");
		System.out.println(sb.toString());
		ruleCoreference.english.RuleCoref.run(args, bs2, "2");
	}
	
	public static double evaluate(String language, String folder) throws Exception {
		String baseFolder = "/users/yzcchen/chen3/conll12/" + language + "/" + folder + "_development2/key.";
