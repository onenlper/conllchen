...
//		features.add(new Feature(charDis, 11));
		...
		// 29 COPULAR
		if (ml.chCommon.isCopular2(candidate, current, sentences)) {
			features.add(new Feature(0, 2));
		} else {
			features.add(new Feature(1, 2));
		}
...
//		}
		...
		// RoleAppositive
		if (ml.chCommon.isRoleAppositive(candidate, current, part)) {
			if (appoPairs.containsKey(current)) {
				EntityMention title = appoPairs.get(current);
				if (candidate.headStart < title.headStart) {
					appoPairs.put(current, candidate);
				}
			} else {
				appoPairs.put(current, candidate);
			}
		...
		// boost features according to mention type, boost 9 times;
		// int boostValue = 0;
		// if(current.mentionType==MentionType.Nominal) {
		// if(candidate.mentionType==MentionType.Nominal) {
		// boostValue = 0;
		// } else if(candidate.mentionType==MentionType.Pronominal) {
		// boostValue = 1;
		// } else if(candidate.mentionType==MentionType.Proper) {
		// boostValue = 2;
		// }
		// } else if(current.mentionType==MentionType.Pronominal) {
		// if(candidate.mentionType==MentionType.Nominal) {
		// boostValue = 3;
		// } else if(candidate.mentionType==MentionType.Pronominal) {
		// boostValue = 4;
		...
		// boostValue = 5;
		// }
		// } else if(current.mentionType==MentionType.Proper) {
		// if(candidate.mentionType==MentionType.Nominal) {
		// boostValue = 6;
		// } else if(candidate.mentionType==MentionType.Pronominal) {
		// boostValue = 7;
		...
		// feature.index = 9 * boostValue + feature.index;
		// feature.limit = feature.limit * 9;
		// }
