...
public class TuneChineseConstraint {

	public static String sur;
	
	public static void main(String args[]) throws Exception {
		// java ~ chinese nw true
		...
		double t5s = -1;
		double baseline = 0;
		String optFn = language + "_" + folder + "_" + args[2] + "_opt2_only_constraint";
//		String thFile = "chinese_" + folder + "_" + args[2] + "_optTh";
...
//		t5s = Double.valueOf(thLine[4]);
	...
	public static double evaluate(String language, String folder) throws Exception {
		String baseFolder = "/users/yzcchen/chen3/conll12/" + language + "/" + folder + "_development" + sur
				+ "/key.";
